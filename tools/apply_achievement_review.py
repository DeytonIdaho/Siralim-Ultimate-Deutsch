...
RACES={
 'Amphisbaenas':'Amphisbaena','Apises':'Apis','Arbiters':'Schlichter','Basilisks':'Basilisken','Cockatrices':'Cockatrice','Cerberuses':'Zerberusse',
 'Diabolic Hordes':'Diabolische Horden','Doom Fortresses':'Festungen des Untergangs','Doomguards':'Doomgarden','Dumplings':'Knödel','Efreets':'Efreet',
 'Fiends':'Unholde','Forsakens':'Verlassene','Gargantuans':'Gargantuans','Giants':'Riesen','Gemlings':'Edelsteinjünglinge','Hounds':'Hunde','Mimics':'Mimiks',
 'Ophans':'Ophans','Paragons':'Paragons','Pilwizes':'Pilwiz','Rift Dancers':'Dimensionsläufer','Godspawns':'Gottesbrut','Animations':'Animationen',
 'Beacons':'Leuchtfeuer','Cherubs':'Cherubim','Chimeras':'Chimären','Clockworks':'Uhrwerke','Electropods':'Elektropoden','Fae':'Fae','Krakens':'Kraken',
 'Luckmantrias':'Luckmantria','Modrons':'Modron','Mythicants':'Mythicant','Nephilims':'Nephilim','Nihilists':'Nihilisten','Spellmanes':'Zaubermähnen',
 'Uraloses':'Uralos','Warhogs':'Kriegseber','Calumniers':'Calumnier','Cataclysms':'Kataklysmen','Effigies':'Abbilder','Lucanians':'Lucanian',
 'Marionettes':'Marionetten','Robodomis':'Robodomi','Spacecats':'Weltraumkatzen','Spelljugglers':'Zauberjongleure','Elementasaurs':'Elementasaurier',
 'Mirelings':'Mireling','Underdwellers':'Unterirdische','Eggxotics':'Eggxotic','Denizens':'Bewohner'
}

# English achievement title name -> authoritative relic token used by its paired description.
RELICS={
 'Mutatias':'{RELIC_ALEXANDRIA}','Ribcracker':'{RELIC_ARIAMAKI}','Brambleskin':'{RELIC_GENAROS}','Ripplevein':'{RELIC_MUSE}',
 'Fatum and Fortuna':'{RELIC_RECLUSA}','5740-NG':'{RELIC_ROBO}',
}
...
def fix(en,de):
    ...
    # Relic title names are plain English, while descriptions carry authoritative RELIC tokens.
