...
FIX={
'L_FAMILIAR':'Vertrauter','L_LEECH':'Blutegel','L_MIMIC':'Mimic','L_EFREET':'Ifrit',
...
'L_CRIT_GRAVEBANEWIGHT':'Grabfluch-Wiedergänger','L_CRIT_TREPIDATIONWIGHT':'Angst-Wiedergänger','L_CRIT_HEADLESSWIGHT':'Kopfloser Wiedergänger','L_CRIT_HOLYWIGHT':'Heiliger Wiedergänger',
