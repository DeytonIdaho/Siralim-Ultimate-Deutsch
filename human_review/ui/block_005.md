# Human review: ui.csv — 401-500

| Row | English | German |
|---:|---|---|
| 402 | Creature Parts | Kreaturenteile |
| 403 | Arcane Dust | Arkaner Staub |
| 404 | Press {KEYF} to cancel this Project. | Drücke {KEYF}, um dieses Projekt abzubrechen. |
| 405 | Are you sure? Press {KEYE} to confirm you want to cancel. | Bist du sicher? Drücke {KEYE}, um zu bestätigen, dass du abbrechen möchtest. |
| 406 | You have not met any gods yet. | Du hast noch keine Götter getroffen. |
| 407 | Rank {1} | Rang {1} |
| 408 | You do not have an active Bounty. | Du hast keinen aktiven Kopfgeldauftrag. |
| 409 | Bounty | Kopfgeld |
| 410 | Target: {1} | Ziel: {1} |
| 411 | Realm Depth: {1} | Reichtiefe: {1} |
| 412 | Guild: {1} | Gilde: {1} |
| 413 | Runes (Total Bonus: {1}%) | Runen (Gesamtbonus: {1}%) |
| 414 | You haven't collected any Runes yet. | Du hast noch keine Runen gesammelt. |
| 415 | Press {KEYF} to cancel this Bounty. | Drücke {KEYF}, um diesen Kopfgeldjagdauftrag abzubrechen. |
| 416 | Are you sure? Press {KEYE} to confirm you want to cancel. | Bist du sicher? Drücke {KEYE}, um zu bestätigen, dass du abbrechen möchtest. |
| 417 | You do not have any Anointments equipped. | Du hast keine Salbungen ausgerüstet. |
| 418 | Rank {1} | Rang {1} |
...
| 433 | Add Decoration | Dekoration hinzufügen |
| 434 | Set Wall Style | Wandstil festlegen |
| 435 | Set Floor Style | Bodenstil festlegen |
| 436 | Set Background Style | Hintergrundstil festlegen |
| 437 | Set Music | Musik einstellen |
| 438 | Set Weather | Wetter einstellen |
| 439 | Rename Castle | Burg umbenennen |
| 440 | Zoom In | Heranzoomen |
| 441 | Zoom Out | Herauszoomen |
| 442 | Double Walk Speed | Doppelte Gehgeschwindigkeit |
| 443 | Normal Walk Speed | Normale Gehgeschwindigkeit |
| 444 | Respawn Everett | Everett wiederbeleben |
| 445 | Reset Castle Layout | Burganlage zurücksetzen |
| 446 | Exit Decoration Mode | Dekorationsmodus verlassen |
| 447 | Close Menu | Menü schließen |
| 448 | Confirm Reset | Zurücksetzen bestätigen |
| 449 | Cancel | Abbrechen |
| 450 | Altars | Altäre |
| 451 | Banners | Banner |
| 452 | Columns | Säulen |
| 453 | Floor Tiles | Bodenfliesen |
| 454 | Lights | Lichter |
| 455 | Miscellaneous | Verschiedenes |
| 456 | Paintings | Gemälde |
| 457 | Plants | Pflanzen |
| 458 | Plushies | Plüschtiere |
| 459 | Rugs | Teppiche |
| 460 | Scrolls | Schriftrollen |
| 461 | Statues | Statuen |
| 462 | Tables/Chairs | Tische/Stühle |
...
| 489 | Select the item set you want to rename. | Wähle das Ausrüstungsset aus, das du umbenennen möchtest. |
| 490 | Notifications ({1}) | Benachrichtigungen ({1}) |
| 491 | You don't have any Cards yet. | Du hast noch keine Karten. |
| 492 | You don't have any Mastery yet. | Du hast noch keine Meisterschaft. |
| 493 | You haven't unlocked any Anointments yet. | Du hast noch keine Salbungen freigeschaltet. |
| 494 | You do not have any creatures in your party! | Du hast keine Kreaturen in deiner Gruppe! |
| 495 | You cannot manage your Item Sets while you are outside of {1}. | Du kannst deine Gegenstandssets nicht verwalten, während du dich außerhalb von {1} befindest. |
| 496 | You cannot equip an Artifact while you are outside of {1}. | Du kannst kein Artefakt ausrüsten, während du dich außerhalb von {1} befindest. |
| 497 | You cannot unequip an Artifact while you are outside of {1}. | Du kannst ein Artefakt nicht ablegen, während du dich außerhalb von {1} befindest. |
| 498 | You cannot equip a Spell Gem while you are outside of {1}. | Du kannst keinen Zauberstein ausrüsten, während du dich außerhalb von {1} befindest. |
| 499 | You can't use this option yet. | Du kannst diese Option noch nicht verwenden. |
| 500 | You can't use this option here. | Du kannst diese Option hier nicht verwenden. |
| 501 | You do not have any creatures in your party! Items are useless without creatures to use them. | Du hast keine Kreaturen in deiner Gruppe! Gegenstände sind nutzlos ohne Kreaturen, die sie verwenden können. |
